...
<div class="container">
    <div class="row justify-content-center">
     <div class="col-md-8" style="margin-top: 25px; border-style: ridge; border-radius: 5px; padding-bottom: 25px;"> 
       <!--      <div class="card">  -->
                <div class="card-header" style="margin-top:20px;">Login</div>
